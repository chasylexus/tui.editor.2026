...
```
- node_modules/@techie_doubts/tui.editor.2026/dist/
  - i18n/
    - ko-kr.js
    - ...
```
...
```js
import '@techie_doubts/tui.editor.2026/dist/i18n/${fileName}';
```

### CommonJS

```js
require('@techie_doubts/tui.editor.2026/dist/i18n/${fileName}');
```
...
import '@techie_doubts/tui.editor.2026/dist/i18n/ko-kr';
