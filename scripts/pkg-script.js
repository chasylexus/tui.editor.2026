...
const pkgMap = {
  editor: '@techie_doubts/tui.editor.2026',
  react: '@techie_doubts/react-editor',
  vue: '@techie_doubts/vue-editor',
  toastmark: '@techie_doubts/toastmark',
  chart: '@techie_doubts/editor-plugin-chart',
  color: '@techie_doubts/editor-plugin-color-syntax',
  code: '@techie_doubts/editor-plugin-code-syntax-highlight',
  table: '@techie_doubts/editor-plugin-table-merged-cell',
  uml: '@techie_doubts/editor-plugin-uml',
};
